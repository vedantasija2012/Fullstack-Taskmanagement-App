    ...
    return (
        <div className='home shadow-xl p-2 w-1/3 my-4 mx-auto flex flex-col items-center justify-center'>
            <div className="upper my-2 p-4">
                <h1 className='text-xl text-center font-bold'>TASKFLOW</h1>
                <img src={logo} className='h-[35vh]' alt="Error" />
            </div>
            <div className="lower my-2 p-4">
                <p className='font-bold'>
                    Taskflow is a minimalist note-taking and Task management app designed to inspire your imagination in a grayscale world. Step into a captivating real where shades of gray awaken your creativity and enable your ideas to take center stage
                </p>
            </div>
